...
export const Searchbar = ({
  ...
  return (
    <section className='py-6 flex items-center gap-4 w-full flex-wrap'>
      <input
        type='text'
        className='rounded-full outline-none px-4 bg-sd h-12 w-full text-txtGray min-w-[230px]'
      ...
      <div className='flex items-center gap-2 md:gap-4 w-full'>
        <select
          ...
          className='h-12 bg-sd w-fit md:w-full text-white/80 rounded-full px-5 outline-none cursor-pointer hover:bg-sd/70'
        >
